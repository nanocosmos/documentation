...
With the release of version `3.7.1.0`, the [nanoStream Cloud Dashboard](https://dashboard.nanostream.cloud/) has enhanced its user interface in addition to the [Analytics Dashboard](https://metrics.nanostream.cloud).
:::
...
:::tip Troubleshooting
The troubleshooting page on the [Analytics Dashboard](https://metrics.nanostream.cloud/) helps to investigate stream or user specific metrics across the streaming experience from stream ingest to the playout at the enduser. <br/>
