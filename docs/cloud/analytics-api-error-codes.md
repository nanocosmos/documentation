...
|------------|------------|-------------|-----------|
| 10**1001** | Endpoint not found | The requested URL was not found on this server. This may happen if you are trying to access a wrong/unavailable URI endpoint. Please verify, that your request will be send to `https://metrics-api.nanostream.cloud/v2/<path-of-your-desired-endpoint>`. | 404 | 
...
| 10**1005** | Too many params | The route you are trying to access does have a maximum limit of parameters. Some routes do have a limit for stream names or tags filter. Please refer to our [API documentation](https://api.nanostream.cloud/docs/analytics/v2/) to check if there are limitations to the used route. | 400 |
...
| 10**1007** | Missing props request body | The request body has missing properties. Check your request body content and compare it with the route requirements at our [API documentation](https://api.nanostream.cloud/docs/analytics/v2/) | 422 | 
...
Learn to specify your request correctly by taking a look at our [API documentation](https://api.nanostream.cloud/docs/analytics/v2/).
...
| 10**5003** | Access for Analytics Dashboard only | Access denied: This route does not support requests via API. Please consider using our [Analytics Dashboard](https://api.nanostream.cloud/docs/analytics/v2/) to access further utilities and details about your live streams and audience! | 403 |
