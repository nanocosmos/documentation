...
For API route specifications please refer to our <a className="badge-inText" href="https://api.nanostream.cloud/docs/analytics/v2/">technical API documentation. ⚙️</a>
...
- [SPSR API Routes](https://api.nanostream.cloud/docs/analytics/v2/#tag/Playback-start-success)
- [PSE API Routes](https://api.nanostream.cloud/docs/analytics/v2/#tag/Playback-start-errors)
...
`/v2/playback/start/success/ratio/timeseries?from=2024-04-09T00%3A00&to=2024-04-11T00%3A00&interval=hour` 
...
`/v2/playback/start/success/ratio/world?from=2024-04-10T19%3A00&to=2024-04-10T21%3A00`
...
`/v2/playback/start/errors/countries/ip?from=2024-04-10T19%3A00&to=2024-04-10T21%3A00&countries=AM`
